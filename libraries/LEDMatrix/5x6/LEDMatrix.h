...
class LEDMatrix{
  public:
    LEDMatrix(bool mode);
	void begin(short int C1,short int C2,short int C3,short int C4,short int C5, short int C6, short int L1,short int L2,short int L3,short int L4,short int L5);
